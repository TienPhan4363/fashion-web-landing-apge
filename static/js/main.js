...
setTimeout(() => {
    productInfors[productIndex].classList.add('active');
}, 200);
...
slide = () => {
    ...
    let currProduct = document.querySelector('.product-infor.active');
    currProduct.classList.remove('active');

    productIndex =
        productIndex + 1 > productInfors.length - 1 ? 0 : productIndex + 1;
    productInfors[productIndex].classList.add('active');
